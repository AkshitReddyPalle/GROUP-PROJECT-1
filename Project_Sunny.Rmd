...
ggplot( data=data2, aes(Median_household_income))+
  geom_histogram(binwith=5000, col="black", fill="lightblue")+
...
```
# ANOVA Test
Let's see if the Total number of maternal deaths per 100,000 population and Total number of drug overdose deaths involving any opioid per 100,000 population are different among different Income groups.

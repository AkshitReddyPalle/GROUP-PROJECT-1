...
The total number of maternal deaths between different income group are different but the pattern in the number of drug overdose deaths is not that clear from the boxplots.
